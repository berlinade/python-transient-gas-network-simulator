...
class internal_pipe(base_edge):

    def __init__(self, name : str, net : network_dae,
                 left : node_t, right : node_t):
        super().__init__(name = name, edge_type = "internal-pipe", net = net, dim = 2,
                         left = left, right = right, _type_prefix = "hidden|")
